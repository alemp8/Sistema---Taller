...
import com.progmulti.proyectofinal.sistema.taller.Controlador.ControladorModelos;
...
public class Modelos extends javax.swing.JFrame {
    ControladorModelos controlador = new ControladorModelos();
    int fila;
    Long codigo = 0L;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Lista de Modelos");
